...
def load_tasks():
    ...
    # validation tasks
    data_val = pd.read_csv(f"/homes/ss2971/Documents/AHO/AHO_FP/val_tasks_wo_cluster.csv")
    dataset_val_tasks = {
        'cluster': ['C1']
    }
    ...
    # test tasks
    data_test = pd.read_csv(f"/homes/ss2971/Documents/AHO/AHO_FP/test_tasks_wo_cluster.csv")
    dataset_test_tasks = {
        'cluster': ['C1','C2']
    }
