...
import torch
import numpy as np
from adkf_utils import ADKFModelTrainerConfig, ADKFModelTrainer
...
def parse_command_line():
    ...
    parser.add_argument("--validate_every", type=int, default=50, help="Number of training steps between model validations.")
...
def make_trainer_config(args: argparse.Namespace) -> ADKFModelTrainerConfig:
    return ADKFModelTrainerConfig(
...
def main():
    ...
    model_trainer = ADKFModelTrainer(config=config).to(device)
